...
// 计价
function price (market, fxType) {
  baseurl = '/pfx'
  let url = fxType === 'FX_OPTN' ? '/fx/price' : fxType === 'FX_SPRD' ? '/sprd/price' : fxType === 'FX_STRANGLE' ? '/str/price' : fxType === 'FX_COLLAR' ? '/col/price' : fxType === 'FX_DIG' ? '/fx/dig/price' : fxType === 'FX_FWRD' ? '/fx/fwrd/price' : '/fx/price'
  let sendType = 'POST'
